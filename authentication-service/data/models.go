...
// app variable is used, provided that the model is also aded in the New function.
type Models struct {
	User User
}
...
// New is the function used to create an instance of the data package. It returns the type Model,
...
// ResetPassword is method we will use to change a user's password
...
// and the hash match, we return true; otherwise, we return false.
